  ...
  return (
    ...
    <div className="container mx-auto px-4 flex flex-col items-center gap-16">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-semibold text-gray-800 mb-6 leading-snug">
          ...
          <button className="px-8 py-4 bg-cyan-600 text-white text-lg font-medium rounded-lg shadow-lg hover:bg-cyan-700 transition duration-300">
            Learn More
          </button>
        </motion.div>
        ...
        >
          <img
            src={travel}
            alt="Travel"
            className="rounded-2xl max-w-[100%] lg:max-w-[130%] h-auto"
          />
        </motion.div>
    ...
    {/* Decorative Element */}
    <motion.div
      className="absolute -top-16 -left-16 w-64 h-64 bg-cyan-100 rounded-full blur-2xl"
